 ...
 * Формула: y(x) = 1 / [1 + exp(-1 * b * (x - c))]
 * b - bending coefficient (bendCoef).При b > 0 - функция возрастает, при b < 0 - убывает. В целом, чем больше число в любую из
 * сторон, тем "круче" становится сигмоида, она начинает больше ложиться на верхние и нижние пределы.
 * c - shiftOnX, в целом это примерно сдвиг сигмоиды по оси Х. Также это значение Х при котором y(x) = 0.5.
 */
